...
The objective is to replicate and compare several filtering and parameter estimation methods for the hidden Markov model considered in the paper, using S&P 500 data.
